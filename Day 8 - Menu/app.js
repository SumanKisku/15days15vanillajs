...
// making unique category list
menu.forEach((item)=> {
  if(!categories.includes(item.category)) { // if categories dosn't include current category, push it to the categories
